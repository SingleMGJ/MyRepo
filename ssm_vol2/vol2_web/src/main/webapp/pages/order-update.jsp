			...
			<form action="${pageContext.request.contextPath}/order/updateOrder" method="post">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a6" value="${order.product.departureTimeStr }" name="product.departureTime">
							</div>
						</div>
				...
				<div class="panel panel-default">
					...
					<table id="dataList"
						...
						<tbody>
							<c:forEach var="traveller" items="${order.travellers}" varStatus="vs">
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						<input type="hidden" name="member.id" value="${order.member.id}">
						<div class="col-md-2 title">会员</div>
						<div class="col-md-4 data text">
						
							<input type="text" class="form-control" value="${order.member.nickname }" name="member.nickname">
						...
						<div class="col-md-4 data text">
							...
							<input type="text" value="${order.member.name}" name="member.name" class="form-control">
						
						</div>

						<div class="col-md-2 title">手机号</div>
						<div class="col-md-4 data text">
							<input type="text" value="${order.member.phoneNum}" name="member.phoneNum" class="form-control">
						</div>

						<div class="col-md-2 title">邮箱</div>
						<div class="col-md-4 data text">
							<input type="text" value="${order.member.email}" name="member.email" class="form-control">
						</div>
				...
				<c:if test="${order.orderStatus==1}">
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data text">在线支付-<input type="text" value="${order.payTypeStr}" name="payType"></div>

							<div class="col-md-2 title">金额</div>
							<div class="col-md-4 data text">￥<input type="text" value="${order.product.productPrice}" name="product.productPrice"></div>
