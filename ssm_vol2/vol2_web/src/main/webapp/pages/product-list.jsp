                        ...
                        <table id="dataList"
                            ...
                            <c:forEach items="${productList}" var="product" varStatus="s">
                                <tr>
                                    ...
                                    <%--<c:choose>--%>
                                        <%--<c:when test="${product.productStatus ==1}"><td>已处理</td></c:when>--%>
                                        <%--<c:otherwise><td>未处理</td></c:otherwise>--%>
                                    <%--</c:choose>--%>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick='location.href="${pageContext.request.contextPath}/product/productDisplay?id=${product.id}"'>查看</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                                ...
                                <div class="btn-group">
                                    ...
                                    <script type="text/javascript">
                                        function deleteBatch() {
                                            var checkArr = $("#dataList td input[type='checkbox']:checked");
                                            if (checkArr.length > 0) {
                                                ...
                                                {
                                                    idsArr.push(checkArr[i].value);
                                                }
                                                var ids = idsArr.join(",")
                                                location.href="${pageContext.request.contextPath}/product/deleteBatch?ids="+ids;
                                            }else {
                                                alert("请选择要删除的项目");
                                            }
                                        }
